    ...
    var text = document.getElementById('output')
     ...
     function backUp() {
        ...
        function removeBold(){
            ...
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Figures', '<?A3B2 show [bold]?><bold>Figures')
            userInput = userInput.replaceAll('<bold>Figures', '<?A3B2 show [bold]?><bold>Figures')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Figure', '<?A3B2 show [bold]?><bold>Figure')
            userInput = userInput.replaceAll('<bold>Figure', '<?A3B2 show [bold]?><bold>Figure')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Tables', '<?A3B2 show [bold]?><bold>Tables')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Tables', '<?A3B2 show [bold]?><bold>Tables')
            userInput = userInput.replaceAll('<bold>Tables', '<?A3B2 show [bold]?><bold>Tables')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Table', '<?A3B2 show [bold]?><bold>Table')
            userInput = userInput.replaceAll('<bold>Table', '<?A3B2 show [bold]?><bold>Table')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Supplementary', '<?A3B2 show [bold]?><bold>Supplementary')
            userInput = userInput.replaceAll('<bold>Supplementary', '<?A3B2 show [bold]?><bold>Supplementary')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Supplemental', '<?A3B2 show [bold]?><bold>Supplemental')
            userInput = userInput.replaceAll('<bold>Supplemental', '<?A3B2 show [bold]?><bold>Supplemental')
            userInput = userInput.replaceAll('<?A3B2 show [bold]?><bold>Appendix', '<?A3B2 show [bold]?><bold>Appendix')
